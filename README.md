[![Build Status](https://travis-ci.org/datingel/js-training.svg?branch=master)](https://travis-ci.org/datingel/js-training)
## Setup
First, [**fork**](https://github.com/datingel/js-training/fork?fragment=1) this repository.
...
./tester
```
![output-tester](https://github.com/datingel/js-training/blob/master/img/output-tester.png)
